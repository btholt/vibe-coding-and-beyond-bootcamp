...
- _authors_ – An array of author objects. Any number is supported. The home page renders them in a row on desktop and stacked on smaller screens; on desktop they'll wrap to additional rows if there isn't enough room.
- _authors[].name_ – The author's name
- _authors[].company_ – The company the author works at or whatever you want as their subtitle. Optional.
